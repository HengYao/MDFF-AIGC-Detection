...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--rota_prob', type=float, default=0)
        parser.add_argument('--color_prob', type=float, default=0)
        ...
        parser.add_argument('--flag',type=float, default=0)
        parser.add_argument('--count', type=float, default=0,help ='用来判断准确率是否连续下降，如果连续下降3次，考虑降低后处理概率')
        parser.add_argument('--flag2', type=float, default=0,help='如果train切换到eval模式要调用validate，则置为1，让trainer的掩码率不增加')
        ...
        parser.add_argument('--name', type=str, default='三特征', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--epoch', type=str, default='latest', help='which epoch to load? set to latest to use latest cached model')
        parser.add_argument('--num_threads', default=4, type=int, help='# threads for loading data')
        parser.add_argument('--checkpoints_dir', type=str, default='./dnf_checkpoints', help='models are saved here')
